...
<jsp:useBean id="dto" class="com.answer.dto.AnswerDto" scope="request"></jsp:useBean>
	...
	<table border="1">
		...
		<tr>
			...
			<td colspan="2"><input type="button" value="수정" onclick="location.href='answer.do?command=update&boardno=${dto.boardno}'">
			<input type="button" value="답글달기" onclick="location.href='answer.do?command=rewrite&boardno=${dto.boardno}'"> 
				<input type="button" value="삭제" onclick="location.href='answer.do?command=delete&boardno=${dto.boardno}'"> 
				
				<input type="button" value="목록" onclick="location.href='answer.do?command=list'"></td>
		</tr>
	</table>
